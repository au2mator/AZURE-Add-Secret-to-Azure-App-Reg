...
# Code Template V 1.5
#
# Github: https://github.com/au2mator/AZURE-Add-Secret-to-Azure-App-Reg
#
#
# au2mator is happy to support you with your Automation
# Contact us here: https://au2mator.com/premier-services/?utm_source=github&utm_medium=social&utm_campaign=AZURE_AddSecretToAppReg&utm_content=PS1
#
#################
...
## Environment
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\AZURE - Add Secret to Azure App Reg\Logs"
[string]$LogfileName = "AZURE - Add Secret to Azure App Reg"
[string]$CredentialStorePath = "C:\_SCOworkingDir\TFS\PS-Services\CredentialStore" #see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_AddSecretToAppReg&utm_content=PS1
...
$ChannelName = "General"
###TeamsCredentials to send Teams Card #https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_AddSecretToAppReg&utm_content=PS1
...
###Stored Credentials
###See: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=AZURE_AddSecretToAppReg&utm_content=PS1
...
$GetApp_Params = @{
    Method = "GET"
    Uri    = "$MSGRAPHAPI_BaseURL/applications/$($c_AppID)"
    header = $MSGRAPHAPI_headers
}

$GetApp_Result = Invoke-RestMethod @GetApp_Params
Write-au2matorLog -Type INFO -Text "received APP Details"


        $AddSecret_Params = @{
            Method = "POST"
            Uri    = "$MSGRAPHAPI_BaseURL/applications/$($c_AppID)/addPassword"
            header = $MSGRAPHAPI_headers
            body   = $AddSecret_Body
        }

        $AddSecret_Result = Invoke-RestMethod @AddSecret_Params
        Write-au2matorLog -Type INFO -Text "Secret added successfull"
                        
        $au2matorReturn = "New Secret created:
                                        <br>
                                        AppName:$($GetApp_Result.displayname) 
                                        <br>
        ...
        $TeamsReturn = "Secret added successfull" #No Special Characters allowed
        $AdditionalHTML = "Secret added successfull
                    <br>
                        "
        $Status = "COMPLETED"
